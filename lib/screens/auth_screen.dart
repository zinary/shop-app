...
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      var errorMessage = 'Authentication failiure';
      if (error.message.contains('EMAIL_EXISTS')) {
        errorMessage = 'Email address is already registered. try login.';
        ...
        errorMessage = 'Invalid password is entered';
      }
    ...
    return Card(
      ...
      child: AnimatedContainer(
        ...
        constraints: BoxConstraints(
          minHeight: _authMode == AuthMode.Login ? 260 : 340,
        ),
